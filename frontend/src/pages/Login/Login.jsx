  ...
  return (
    <main className="login-page" id="login-page">
      <div className="login-card">
        ...
        <p className="login__sub">Login to save files, access history, and use the AI assistant.</p>

        {/* OAuth buttons */}
        <div className="login__btns">
          <a
            href="/auth/github"
            className="login__btn login__btn--github"
            id="login-github"
          >
        ...
        <p className="login__terms">
          ...
          <span className="login__guest">
            Just want to try? <Link to="/ide">Open IDE as guest →</Link>
          </span>
        </p>
      </div>
